export const selectedTimeData = {
  ...
  selectTime: [
    ...
    {
      time: '2024-07-01T08:30',
      users: ['오영', '채림', '구예진', '고세종'],
      userCount: 4,
    },
    {
      time: '2024-07-01T09:00',
      users: ['오영', '채림', '구예진', '고세종', '류지민'],
      userCount: 5,
    },
    // 사용자가 일부 변경된 경우
    {
      time: '2024-07-01T09:30',
      users: ['오영', '채림', '류지민', '김유희'],
      userCount: 4,
    },
    {
    ...
    {
      time: '2024-07-01T10:30',
      users: ['김유희', '경효선', '김수현'],
      userCount: 3,
    },
    {
      time: '2024-07-01T11:00',
      users: ['경효선', '김수현', '김민우'],
      userCount: 3,
    },
    {
      time: '2024-07-01T11:30',
      users: ['김수현', '김민우', '류지민'],
      userCount: 3,
    },
    // 전혀 다른 사용자들이 포함된 경우
    ...
    {
      time: '2024-07-01T13:00',
      users: ['김수현', '채림', '김유희'],
      userCount: 3,
    },
    {
      time: '2024-07-01T13:30',
      users: ['고세종', '김민우'],
      userCount: 2,
    },
    // 연속된 시간 동안 여러 사용자가 포함된 경우
    {
      ...
      users: ['김수현', '김유희', '구예진', '류지민'],
      userCount: 4,
    },
    {
      time: '2024-07-01T14:30',
      users: ['김수현', '김유희', '구예진', '류지민'],
      userCount: 4,
    },
    {
      time: '2024-07-01T15:00',
      users: ['김수현', '김유희', '구예진', '류지민', '오영'],
      userCount: 5,
    },
    {
      time: '2024-07-01T15:30',
      users: ['김수현', '김유희', '구예진', '류지민', '오영', '채림'],
      userCount: 6,
    },
    {
      time: '2024-07-01T16:00',
      users: ['김수현', '김유희', '구예진', '류지민', '오영', '채림', '경효선'],
      userCount: 7,
    },
    {
      time: '2024-07-01T16:30',
      users: [
        '김수현',
        '김유희',
        '구예진',
    ...
    },
    {
      ...
      users: ['김수현', '구예진', '김유희', '오영'],
      userCount: 4,
    },
    {
      time: '2024-07-01T18:30',
      users: ['김수현', '구예진', '김유희', '오영', '채림'],
      userCount: 5,
    },
    // 밤 시간대에 사용자가 적은 경우
    {
      time: '2024-07-01T19:00',
      users: ['김수현', '오영', '채림'],
      userCount: 3,
    },
    {
    ...
    {
      time: '2024-07-01T22:00',
      users: ['김수현', '김민우', '오영', '경효선', '구예진', '류지민'],
      userCount: 6,
    },
    {
      time: '2024-07-01T22:30',
      users: ['김수현', '김민우', '오영', '경효선', '구예진', '류지민', '채림'],
      userCount: 7,
    },
    {
    ...
    {
      time: '2024-07-02T07:30',
      users: ['김민우', '경효선', '류지민'],
      userCount: 3,
    },
    {
      time: '2024-07-02T08:00',
      users: ['김민우', '경효선', '류지민', '오영'],
      userCount: 4,
    },
    {
      time: '2024-07-02T08:30',
      users: ['김민우', '경효선', '류지민', '오영', '김수현'],
      userCount: 5,
    },
    {
      time: '2024-07-02T09:00',
      users: ['김민우', '경효선', '류지민', '오영', '김수현', '채림'],
      userCount: 6,
    },
    {
